...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 2884;
        $headers['auth']['clientCompany'] = "mSxpGXj3fGipWqeQV1y0";
        $headers['auth']['clientSecret'] = "Mjg4NG1TeHBHWGozZkdpcFdxZVFWMXkwY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
